...
function Dialog({ statusColumn, visible, setContent, setShowDialog, dialogContent, setDialogContent }) {
	...
	return visible ? (
		<div className="fixed h-full w-full bg-slate-300/50">
			<form action="" ref={cardAddForm} onSubmit={dialogContent._id ? updateCard : addNewCard} className="flex flex-col bg-white p-4 gap-3 xl:rounded fixed xl:w-[500px] w-full xl:h-[500px] h-full top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] drop-shadow-md">
